...
class IntegerRange:
    ...
    def __get__(self, instance: Slide, owner: Slide) -> int:
...
baby = Visitor(name="t", age=10, weight=30, height=120)
slide = Slide(name="baby", limitation_class=ChildrenSlideLimitationValidator)

print(slide.can_access(baby))
